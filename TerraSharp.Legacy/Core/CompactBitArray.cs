...
using CN = TerraProto.CSharp.third_party.proto.cosmos.tx.signing.v1beta1;
using COMB = TerraProto.CSharp.third_party.proto.cosmos.crypto.multisig.v1beta1;
...
namespace TerraSharp.Core
{
    public class CompactBitArray
    {
        ...
        public static CompactBitArray FromProto(TerraProto.CSharp.third_party.proto.cosmos.tx.signing.v1beta1.CompactBitArray proto)
        {
            return new CompactBitArray(proto.ExtraBitsStored, proto.Elems);
        }
