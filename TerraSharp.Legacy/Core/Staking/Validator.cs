...
using TerraSharp.Core.Staking.TerraSharp.Core.Staking.Validators.CommissionsRates;
...
{
    using VAL_DESC = TerraSharp.Core.Staking.Validators.Description;
    using CM = TerraSharp.Core.Staking.Validators.Commissions;
    ...
    namespace TerraSharp.Core.Staking.Validators.Description
    {
    ...
    namespace TerraSharp.Core.Staking.Validators.CommissionsRates
    {
    ...
    namespace TerraSharp.Core.Staking.Validators.Commissions
    {
