...
using System;
using Terra.Microsoft.Client.Core.Bank.Msgs.Terra.Microsoft.Client.Core.Bank.Msgs.Output;
using Terra.Microsoft.Client.Core.Bank.Msgs.Terra.Microsoft.Client.Core.Bank.Msgs.Input;
...
namespace Terra.Microsoft.Client.Core.Bank.Msgs
{
    ...
    namespace Terra.Microsoft.Client.Core.Bank.Msgs.Input
    {
        public class Input
        {
    ...
    namespace Terra.Microsoft.Client.Core.Bank.Msgs.Output
    {
        public class Output
        {
            public List<Coin> coins;
